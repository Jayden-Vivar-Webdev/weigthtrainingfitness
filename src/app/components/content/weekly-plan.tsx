import {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Book sessions at times that work for you wether thats in morning, evening, or weekend.',
      icon: UserGroupIcon,
    },
    {
      name: 'Results Focused',
      description: 'Our proven methods are designed to deliver real, measurable results in a short time.',
      icon: BoltIcon,
    },
    {
      ...
      <div id='weeklypt' className="bg-gray-900/80 pb-24 sm:py-32 relative">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="lg:mt-2 text-pretty text-4xl font-semibold leading-tight tracking-tight text-white sm:text-balance sm:text-5xl">
              5 x Personal Training Session Package
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Lock in 5 personalised training sessions for just <span className="font-bold text-white">$250</span>. Get dedicated 1 on 1 coaching, customised programming, and the accountability you need to achieve your fitness goals.
            </p>
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-5xl px-6 lg:px-8">
            <Image
              ...
              width={2432}
              height={1442}
              className="mb-[-1%] rounded-xl shadow-2xl ring-1 ring-white/10"
            />
            <div aria-hidden="true" className="relative">
              <div className="absolute -inset-x-20 bottom-0 bg-gradient-to-t from-gray-900/70 pt-[7%]" />
            </div>
          </div>
        </div>
