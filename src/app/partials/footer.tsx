...
const navigation = {
    services: [
      ...
      { name: 'Mobile Personal Training', href: '/services' },
      { name: 'Fitness Goals', href: '/services' },
      { name: 'Weight Loss', href: '/services' },
  ...
  export default function Footer() {
    return (
      <footer className="bg-black border-t-[1px] border-gray-700">
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              <div className="flex w-[20rem] max-h-[8rem] overflow-hidden justify-center items-center">
                <Image
                    alt="Company name"
                    src="/images/logo.png"
                    width={500}
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-sm/6 text-gray-400">&copy; 2024 Powered by Nexa Web Development. All Rights Reserved To Weight Training Fitness.</p>
          </div>
        </div>
      </footer>
    )
